...
/**
 * Classname: SizeEstimationWizard
 * 
 * Description: This class creates a Wizard that allows a user to log estimations of the size
 * of their project in Lines of Code (LOC). Users will also be able to log the estimated time
 * that the project will take. This information can/will be used for analysis in the Personal Software Process.
 * 
 * Version: 1.0
 * 
 * Date: 2/21/20156 
...
public class SizeEstimationWizard extends JDialog implements Wizard {
	...
	JLabel addedLabel = new JLabel("<html>Estimated Lines of Code (LOC) to be added:" + "<font color=\"red\">*</font></html>");
	JLabel modifiedLabel = new JLabel("<html>Estimated Lines of Code (LOC) to be modified:" + "<font color=\"red\">*</font></html>");
	JLabel deletedLabel = new JLabel("<html>Estimated Lines of Code (LOC) to be deleted:" + "<font color=\"red\">*</font></html>");
	JLabel timeLabel = new JLabel("<html>Estimated total project time (Hrs):" + "<font color=\"red\">*</font></html>");
	 ...
	 * Constructor
	 */
	public SizeEstimationWizard(Frame frame, String title) {
	...
	public void jbInit() throws Exception {
		...
		headerLabel.setText("<html><font size=\"6\"> Welcome to the Size Estimation Wizard.</font><br>"
				+ " This Wizard will help you to log the estimated size & work needed for your project.</html>");
		...
		header.setText("<html>SIZE" + " EST." + "<br>" + "WIZARD</html>");
		...
		// Adjust Time Spent Text-Box (Time Spent (Hrs):)
		layout.putConstraint(SpringLayout.WEST, timeLabel, 60, SpringLayout.WEST, mainPanel);
		layout.putConstraint(SpringLayout.NORTH, timeLabel, 200, SpringLayout.NORTH, mainPanel);

		layout.putConstraint(SpringLayout.WEST, timeText, 5, SpringLayout.EAST, timeLabel);
		layout.putConstraint(SpringLayout.NORTH, timeText, 200, SpringLayout.NORTH, mainPanel);

		// Adjust Text Area (Notes:)
		layout.putConstraint(SpringLayout.WEST, notesLabel, 60, SpringLayout.WEST, mainPanel);
		layout.putConstraint(SpringLayout.NORTH, notesLabel, 240, SpringLayout.NORTH, mainPanel);
		...
		// Make sure "estimated LOC to be added" field is filled out before
		...
		// Make sure "estimated LOC to be modified" field is filled out before
		// enabling "Finish" button
		...
		// Make sure "estimated LOC to be deleted" field is filled out before
		// enabling "Finish" button
		...
		// Make sure "estimated project time" field is filled out before
		// enabling "Finish" button
		timeText.getDocument().addDocumentListener(new DocumentListener() {
			public void changedUpdate(DocumentEvent e) {
				changed();
			}
	...
	public void changed() {
		...
		else if (timeText.getText().trim().isEmpty()) {
			finishB.setEnabled(false);
		} 
		else {
	...
	public boolean setValues(){
		try{
			...
			_estTime = Double.parseDouble(timeText.getText());
			_notes = txt.getText();
		}
		catch(Exception e){
